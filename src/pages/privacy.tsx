        ...
        <Box background={theme.dark ? "dark-2" : "light-1"}>
          ...
          <Container>
            <Text as="p">
              ...
              the management of the Daniel Wirtz. The use of the Internet pages
              of the Daniel Wirtz is possible without any indication of personal
            ...
            <Text as="p">
              ...
              applicable to the Daniel Wirtz. By means of this data protection
            ...
            <Text as="p">
              As the controller, the Daniel Wirtz has implemented numerous
            ...
            <Heading level="4">1. Definitions</Heading>
            <Text as="p">
              The data protection declaration of the Daniel Wirtz is based on
            ...
            <ul>
              <li>
                <Heading level="4">a)    Personal data</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">b) Data subject</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">c)    Processing</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">d)    Restriction of processing</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">e)    Profiling</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">f)     Pseudonymisation</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">h)    Processor</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">i)      Recipient</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">j)      Third party</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">k)    Consent</Heading>
                <Text as="p">
            ...
            <Heading level="4">2. Name and Address of the controller</Heading>
            <Text as="p">
            ...
            <Text as="p">Daniel Wirtz</Text>
            <Text as="p">Thomashofstr. 4</Text>
            <Text as="p">52070 Aachen</Text>
            <Text as="p">Germany</Text>
            <Text as="p">Phone: /</Text>
            <Text as="p">Email: daniel@crisp.studio</Text>
            <Text as="p">Website: https://danielwirtz.com</Text>

            <Heading level="4">3. Cookies</Heading>
            <Text as="p">
              The Internet pages of the Daniel Wirtz use cookies. Cookies are
            ...
            <Text as="p">
              Through the use of cookies, the Daniel Wirtz can provide the users
            ...
            <Text as="p">
              The website of the Daniel Wirtz collects a series of general data
            ...
            <Text as="p">
              When using these general data and information, the Daniel Wirtz
              ...
              Daniel Wirtz analyzes anonymously collected data and information
            ...
            <Heading level="4">5. Subscription to our newsletters</Heading>
            <Text as="p">
              On the website of the Daniel Wirtz, users are given the
            ...
            <Text as="p">
              The Daniel Wirtz informs its customers and business partners
              ...
              if (1) the data subject has a valid e-mail address and (2) the
              data subject registers for the newsletter shipping. A confirmation
              e-mail will be sent to the e-mail address registered by a data
              subject for the first time for newsletter shipping, for legal
              reasons, in the double opt-in procedure. This confirmation e-mail
              is used to prove whether the owner of the e-mail address as the
            ...
            <Heading level="4">6. Newsletter-Tracking</Heading>
            <Text as="p">
              The newsletter of the Daniel Wirtz contains so-called tracking
              pixels. A tracking pixel is a miniature graphic embedded in such
              e-mails, which are sent in HTML format to enable log file
              ...
              embedded tracking pixel, the Daniel Wirtz may see if and when an
              e-mail was opened by a data subject, and which links in the e-mail
            ...
            <Text as="p">
              ...
              data will be deleted by the controller. The Daniel Wirtz
              automatically regards a withdrawal from the receipt of the
              newsletter as a revocation.
            </Text>

            <Heading level="4">7. Contact possibility via the website </Heading>
            <Text as="p">
              The website of the Daniel Wirtz contains information that enables
            ...
            <Text as="p">
              The comments made in the blog of the Daniel Wirtz may be
            ...
            <Heading level="4">11. Rights of the data subject</Heading>
            <ul>
              <li>
                <Heading level="4">a) Right of confirmation</Heading>
                <Text as="p">
              ...
              <li>
                <Heading level="4">b) Right of access</Heading>
                <Text as="p">
                  Each data subject shall have the right granted by the European
              ...
              <li>
                <Heading level="4">c) Right to rectification </Heading>
                <Text as="p">
                  Each data subject shall have the right granted by the European
              ...
              <li>
                ...
                <Text as="p">
                  ...
                  by the Daniel Wirtz, he or she may, at any time, contact any
                  employee of the controller. An employee of Daniel Wirtz shall
                ...
                <Text as="p">
                  ...
                  employees of the Daniel Wirtz will arrange the necessary
              ...
              <li>
                ...
                <Text as="p">
                  ...
                  personal data stored by the Daniel Wirtz, he or she may at any
                  time contact any employee of the controller. The employee of
                  the Daniel Wirtz will arrange the restriction of the
                  processing.{" "}
                </Text>
              </li>
              <li>
                <Heading level="4">f) Right to data portability</Heading>
                <Text as="p">
                  Each data subject shall have the right granted by the European
                ...
                <Text as="p">
                  ...
                  subject may at any time contact any employee of the Daniel
                  Wirtz.
                </Text>
              </li>
              <li>
                <Heading level="4">g) Right to object</Heading>
                <Text as="p">
                  Each data subject shall have the right granted by the European
                ...
                <Text as="p">
                  The Daniel Wirtz shall no longer process the personal data in
                ...
                <Text as="p">
                  If the Daniel Wirtz processes personal data for direct
                  ...
                  data subject objects to the Daniel Wirtz to the processing for
                  direct marketing purposes, the Daniel Wirtz will no longer
                ...
                <Text as="p">
                  ...
                  Daniel Wirtz for scientific or historical research purposes,
                ...
                <Text as="p">
                  ...
                  contact any employee of the Daniel Wirtz. In addition, the
              ...
              <li>
                ...
                <Text as="p">
                  ...
                  time, contact any employee of the Daniel Wirtz.
                </Text>
              </li>
              <li>
                <Heading level="4">
            ...
            <Text as="p">
              ...
              abridged by Google and anonymised when accessing our websites from
              a Member State of the European Union or another Contracting State
            ...
            <Text as="p">
              ...
              is related to the use of this website, as well as the processing
            ...
            <Text as="p">
              With each call-up to one of the individual pages of this Internet
              site, which is operated by the controller and on which an
              Instagram component (Insta button) was integrated, the Internet
              browser on the information technology system of the data subject
              is automatically prompted to the download of a display of the
              corresponding Instagram component of Instagram. During the course
              of this technical procedure, Instagram becomes aware of what
            ...
            <Text as="p">
              ...
              the data subject. This information is collected through the
              Instagram component and is associated with the respective
              Instagram account of the data subject. If the data subject clicks
              on one of the Instagram buttons integrated on our website, then
              Instagram matches this information with the personal Instagram
              user account of the data subject and stores the personal data.
            </Text>

            <Text as="p">
              Instagram receives information via the Instagram component that
              the data subject has visited our website provided that the data
              subject is logged in at Instagram at the time of the call to our
              website. This occurs regardless of whether the person clicks on
              the Instagram button or not. If such a transmission of information
              to Instagram is not desirable for the data subject, then he or she
              can prevent this by logging off from their Instagram account
              before a call-up to our website is made.
            </Text>

            <Text as="p">
              Further information and the applicable data protection provisions
              of Instagram may be retrieved under
            ...
            <Heading level="4">18. Legal basis for the processing </Heading>
            <Text as="p">
            ...
            <Heading level="4">
              19. The legitimate interests pursued by the controller or by a
              third party
            </Heading>
            <Text as="p">
            ...
            <Heading level="4">
              21. Provision of personal data as statutory or contractual
            ...
            <Text as="p">
              ...
              <a href="https://www.wbs-law.de/eng/">German Lawyers</a> from
