...
const IndexPage = () => (
  <Layout>
    <div className="w-60-ns w-80-m flex-l ">
      <div className="ph4 w8 flex justify-center items-center mt4">
        <img
          className="br2 grow shadow-2 mw5 h-auto nrotate-4 mv4 "
      ...
      <div className="ph4">
        ...
        <div className="flex justify-between mb3 mb0-ns items-center bg-light-gray br-pill">
          <a
            ...
            href="mailto:danielwirtzx+website@gmail.com"
          >
            Say hi ☺︎
          </a>
          <div className="social">
            <a
              class="link blue dark-gray dib h1 h1-ns w1 w1-ns mr3 grow"
            ...
            <a
              class="link purple dark-gray dib h1 h1-ns w1 w1-ns mr3 grow"
            ...
            <a
              class="link orange dark-gray dib h1 h1-ns w1 w1-ns mr3 grow"
            ...
            <a
              class="link blue dark-gray dib h1 h1-ns w1 w1-ns mr3 grow"
              href="https://linkedin.com/in/wirtzdan"
              title="LinkedIn"
            >
              <svg
                fill="currentColor"
